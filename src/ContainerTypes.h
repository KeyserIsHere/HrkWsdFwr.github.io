...
CC_CONTAINER_DECLARE(CCDictionary, CCString, HKHubArchAssemblySymbolExpansionRules); \
...
CC_CONTAINER_DECLARE(CCDictionary, uint8_t, HKHubArchJITBlockReferenceEntry); \
